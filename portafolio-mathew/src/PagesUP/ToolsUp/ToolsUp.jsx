...
const ToolsUp = () => {
  const toolsData = [
    ...
    { texto: "JavaScript", color: "#f0db4f", hovercolor: "#efd81d", percentage: 60, icon: "javascript" },
    ...
    { texto: "ExpressJs", color: "#e1dcd7", hovercolor: "#fbff22", percentage: 50, icon: "express" },
    { texto: "Aws", color: "#adb5c1", hovercolor: "#ff9900", percentage: 30, icon: "aws" },
    { texto: "Nginx", color: "#64fa00", hovercolor: "#f4f4f2", percentage: 30, icon: "nginx" },
